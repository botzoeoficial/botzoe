			...
			sim.on('collect', async (ce) => {
				...
				if (!findSelectedEvento) {
					...
					if (findSelectedEvento.nome === 'Fazenda 1') {
						...
						if (user.fazendas[findFazenda].lote1.fruta === 'Maçã') {
							timeout = 28800000;
						} else if (user.fazendas[findFazenda].lote1.fruta === 'Banana') {
							timeout = 43200000;
						} else if (user.fazendas[findFazenda].lote1.fruta === 'Laranja') {
							timeout = 57600000;
						} else if (user.fazendas[findFazenda].lote1.fruta === 'Limão') {
							timeout = 72000000;
						}

						if (user.fazendas[findFazenda].lote2.fruta === 'Maçã') {
							timeout = 28800000;
						} else if (user.fazendas[findFazenda].lote2.fruta === 'Banana') {
							timeout = 43200000;
						} else if (user.fazendas[findFazenda].lote2.fruta === 'Laranja') {
							timeout = 57600000;
						} else if (user.fazendas[findFazenda].lote2.fruta === 'Limão') {
							timeout = 72000000;
						}

						if (user.fazendas[findFazenda].lote3.fruta === 'Maçã') {
							timeout = 28800000;
						} else if (user.fazendas[findFazenda].lote3.fruta === 'Banana') {
							timeout = 43200000;
						} else if (user.fazendas[findFazenda].lote3.fruta === 'Laranja') {
							timeout = 57600000;
						} else if (user.fazendas[findFazenda].lote3.fruta === 'Limão') {
							timeout = 72000000;
						}

						if (user.fazendas[findFazenda].lote4.fruta === 'Maçã') {
							timeout = 28800000;
						} else if (user.fazendas[findFazenda].lote4.fruta === 'Banana') {
							timeout = 43200000;
						} else if (user.fazendas[findFazenda].lote4.fruta === 'Laranja') {
							timeout = 57600000;
						} else if (user.fazendas[findFazenda].lote4.fruta === 'Limão') {
							timeout = 72000000;
						}

						if (user.fazendas[findFazenda].lote5.fruta === 'Maçã') {
							timeout = 28800000;
						} else if (user.fazendas[findFazenda].lote5.fruta === 'Banana') {
							timeout = 43200000;
						} else if (user.fazendas[findFazenda].lote4.fruta === 'Laranja') {
							timeout = 57600000;
						} else if (user.fazendas[findFazenda].lote4.fruta === 'Limão') {
						...
						msg.edit(author, {
							...
							desbloquear1.on('collect', async (b) => {
								if (b.id === 'desbloquear1') {
									...
									if (user.fazendas[findFazenda].lote1.bloqueado) {
										...
										if (user2.bitcoin < 25) {
											msg.delete();
											return message.reply('você não tem **bitcoins** suficientes para desbloquear o **Lote 1**!');
										}
										...
										await this.client.database.users.findOneAndUpdate({
											...
											$set: {
												'fazendas.$.lote1.bloqueado': false
											}
										});
										...
										embed
											.addField('Lote 1:', `${user2.fazendas[findFazenda].lote1.bloqueado ? `\`Bloqueado\` - Desbloqueie gastando \`25\` BitCoins. ---> 1️⃣\n(Clique na reação 1️⃣ para desbloquear.)` : `${timeout - (Date.now() - user2.fazendas[findFazenda].lote1.cooldown) > 0 ? `**${user2.fazendas[findFazenda].lote1.fruta}** - \`0${ms(timeout - (Date.now() - user2.fazendas[findFazenda].lote1.cooldown)).hours}:${ms(timeout - (Date.now() - user2.fazendas[findFazenda].lote1.cooldown)).minutes}:${ms(timeout - (Date.now() - user2.fazendas[findFazenda].lote1.cooldown)).seconds}\` - **${user2.fazendas[findFazenda].lote1.emoji}** (\`x${user2.fazendas[findFazenda].lote1.quantia}\`)` : user2.fazendas[findFazenda].lote1.fruta === '' ? `\`Pronto para Uso\`` : `\`Pronto para Colheita\` - ${user2.fazendas[findFazenda].lote1.emoji}`} - Clique em 1️⃣ para abrir o **Lote 1**.`}`)
											.addField('Lote 2:', `${user2.fazendas[findFazenda].lote2.bloqueado ? `\`Bloqueado\` - Desbloqueie gastando \`25\` BitCoins. ---> 2️⃣\n(Clique na reação 2️⃣ para desbloquear.)` : `${timeout - (Date.now() - user2.fazendas[findFazenda].lote2.cooldown) > 0 ? `**${user2.fazendas[findFazenda].lote2.fruta}** - \`0${ms(timeout - (Date.now() - user2.fazendas[findFazenda].lote2.cooldown)).hours}:${ms(timeout - (Date.now() - user2.fazendas[findFazenda].lote2.cooldown)).minutes}:${ms(timeout - (Date.now() - user2.fazendas[findFazenda].lote2.cooldown)).seconds}\` - **${user2.fazendas[findFazenda].lote2.emoji}** (\`x${user2.fazendas[findFazenda].lote2.quantia}\`)` : user2.fazendas[findFazenda].lote2.fruta === '' ? `\`Pronto para Uso\`` : `\`Pronto para Colheita\` - ${user2.fazendas[findFazenda].lote2.emoji}`} - Clique em 2️⃣ para abrir o **Lote 2**.`}`)
											.addField('Lote 3:', `${user2.fazendas[findFazenda].lote3.bloqueado ? `\`Bloqueado\` - Desbloqueie gastando \`25\` BitCoins. ---> 3️⃣\n(Clique na reação 3️⃣ para desbloquear.)` : `${timeout - (Date.now() - user2.fazendas[findFazenda].lote3.cooldown) > 0 ? `**${user2.fazendas[findFazenda].lote3.fruta}** - \`0${ms(timeout - (Date.now() - user2.fazendas[findFazenda].lote3.cooldown)).hours}:${ms(timeout - (Date.now() - user2.fazendas[findFazenda].lote3.cooldown)).minutes}:${ms(timeout - (Date.now() - user2.fazendas[findFazenda].lote3.cooldown)).seconds}\` - **${user2.fazendas[findFazenda].lote3.emoji}** (\`x${user2.fazendas[findFazenda].lote3.quantia}\`)` : user2.fazendas[findFazenda].lote3.fruta === '' ? `\`Pronto para Uso\`` : `\`Pronto para Colheita\` - ${user2.fazendas[findFazenda].lote3.emoji}`} - Clique em 3️⃣ para abrir o **Lote 3**.`}`)
											.addField('Lote 4:', `${user2.fazendas[findFazenda].lote4.bloqueado ? `\`Bloqueado\` - Desbloqueie gastando \`25\` BitCoins. ---> 4️⃣\n(Clique na reação 4️⃣ para desbloquear.)` : `${timeout - (Date.now() - user2.fazendas[findFazenda].lote4.cooldown) > 0 ? `**${user2.fazendas[findFazenda].lote4.fruta}** - \`0${ms(timeout - (Date.now() - user2.fazendas[findFazenda].lote4.cooldown)).hours}:${ms(timeout - (Date.now() - user2.fazendas[findFazenda].lote4.cooldown)).minutes}:${ms(timeout - (Date.now() - user2.fazendas[findFazenda].lote4.cooldown)).seconds}\` - **${user2.fazendas[findFazenda].lote4.emoji}** (\`x${user2.fazendas[findFazenda].lote4.quantia}\`)` : user2.fazendas[findFazenda].lote4.fruta === '' ? `\`Pronto para Uso\`` : `\`Pronto para Colheita\` - ${user2.fazendas[findFazenda].lote4.emoji}`} - Clique em 4️⃣ para abrir o **Lote 4**.`}`)
											.addField('Lote 5:', `${user2.fazendas[findFazenda].lote5.bloqueado ? `\`Bloqueado\` - Desbloqueie gastando \`25\` BitCoins. ---> 5️⃣\n(Clique na reação 5️⃣ para desbloquear.)` : `${timeout - (Date.now() - user2.fazendas[findFazenda].lote5.cooldown) > 0 ? `**${user2.fazendas[findFazenda].lote5.fruta}** - \`0${ms(timeout - (Date.now() - user2.fazendas[findFazenda].lote5.cooldown)).hours}:${ms(timeout - (Date.now() - user2.fazendas[findFazenda].lote5.cooldown)).minutes}:${ms(timeout - (Date.now() - user2.fazendas[findFazenda].lote5.cooldown)).seconds}\` - **${user2.fazendas[findFazenda].lote5.emoji}** (\`x${user2.fazendas[findFazenda].lote5.quantia}\`)` : user2.fazendas[findFazenda].lote5.fruta === '' ? `\`Pronto para Uso\`` : `\`Pronto para Colheita\` - ${user2.fazendas[findFazenda].lote5.emoji}`} - Clique em 5️⃣ para abrir o **Lote 5**.`}`);
										...
										message.reply('**Lote 1** desbloqueado com sucesso!').then((a) => a.delete({
											timeout: 7000
										}));
									} else {
										const plantar = msg1.createButtonCollector((button) => button.clicker.user.id === author.id, {
											max: 1
										});

										plantar.on('collect', async (b) => {
															...
															if (timeout - (Date.now() - user.fazendas[findFazenda].lote1.cooldown) > 0) {
																...
																if (user.caixote.find((a) => a.item === user.fazendas[findFazenda].lote1.fruta2)) {
																	await this.client.database.users.findOneAndUpdate({
																		...
																		$set: {
																			'caixote.$.quantia': user.caixote.find((a) => a.item === user.fazendas[findFazenda].lote1.fruta2).quantia + 1
																		}
																	});
																} else {
																	await this.client.database.users.findOneAndUpdate({
																...
																msg.delete();
																return message.reply(`você colheu \`x1\` **${user.fazendas[findFazenda].lote1.fruta2}** do **Lote 1** com sucesso!`);
															}
														}
													});
									...
									if (user.fazendas[findFazenda].lote2.bloqueado) {
										const user2 = await this.client.database.users.findOne({
											userId: author.id,
											guildId: message.guild.id
										});
										...
										if (user2.bitcoin < 25) {
											msg.delete();
											return message.reply('você não tem **bitcoins** suficientes para desbloquear o **Lote 2**!');
										}
										...
										await this.client.database.users.findOneAndUpdate({
											...
											$set: {
												'fazendas.$.lote2.bloqueado': false
											}
										});
										...
										message.reply('**Lote 2** desbloqueado com sucesso!').then((a) => a.delete({
											timeout: 7000
										}));
									} else {
										const plantar = msg1.createButtonCollector((button) => button.clicker.user.id === author.id, {
												...
												if (user.fazendas[findFazenda].lote2.fruta === '') {
													...
													colherFruta.on('collect', async (collected) => {
														...
														if (user.fazendas[findFazenda].lote2.fruta === itemEmoji2) {
															if (timeout - (Date.now() - user.fazendas[findFazenda].lote2.cooldown) > 0) {
																msg.delete();
																return message.reply(`você não pode colher ainda sua **${user.fazendas[findFazenda].lote2.fruta2}**! Espere: \`0${ms(timeout - (Date.now() - user.fazendas[findFazenda].lote2.cooldown)).hours}:${ms(timeout - (Date.now() - user.fazendas[findFazenda].lote2.cooldown)).minutes}:${ms(timeout - (Date.now() - user.fazendas[findFazenda].lote2.cooldown)).seconds}\``);
															} else {
																if (user.caixote.find((a) => a.item === user.fazendas[findFazenda].lote2.fruta2)) {
																	await this.client.database.users.findOneAndUpdate({
																		...
																		$set: {
																			'caixote.$.quantia': user.caixote.find((a) => a.item === user.fazendas[findFazenda].lote2.fruta2).quantia + 1
																		}
																	});
																} else {
																	await this.client.database.users.findOneAndUpdate({
																...
																msg.delete();
																return message.reply(`você colheu \`x1\` **${user.fazendas[findFazenda].lote2.fruta2}** do **Lote 2** com sucesso!`);
															}
														}
													});
									...
									if (user.fazendas[findFazenda].lote3.bloqueado) {
										...
										message.reply('**Lote 3** desbloqueado com sucesso!').then((a) => a.delete({
											timeout: 7000
										}));
									} else {
										const plantar = msg1.createButtonCollector((button) => button.clicker.user.id === author.id, {
												...
												if (user.fazendas[findFazenda].lote3.fruta === '') {
													...
													colherFruta.on('collect', async (collected) => {
														...
														if (user.fazendas[findFazenda].lote3.fruta === itemEmoji2) {
															if (timeout - (Date.now() - user.fazendas[findFazenda].lote3.cooldown) > 0) {
																msg.delete();
																return message.reply(`você não pode colher ainda sua **${user.fazendas[findFazenda].lote3.fruta2}**! Espere: \`0${ms(timeout - (Date.now() - user.fazendas[findFazenda].lote3.cooldown)).hours}:${ms(timeout - (Date.now() - user.fazendas[findFazenda].lote3.cooldown)).minutes}:${ms(timeout - (Date.now() - user.fazendas[findFazenda].lote3.cooldown)).seconds}\``);
															} else {
																if (user.caixote.find((a) => a.item === user.fazendas[findFazenda].lote3.fruta2)) {
																	await this.client.database.users.findOneAndUpdate({
																		...
																		$set: {
																			'caixote.$.quantia': user.caixote.find((a) => a.item === user.fazendas[findFazenda].lote3.fruta2).quantia + 1
																		}
																	});
																} else {
																	await this.client.database.users.findOneAndUpdate({
																...
																msg.delete();
																return message.reply(`você colheu \`x1\` **${user.fazendas[findFazenda].lote3.fruta2}** do **Lote 3** com sucesso!`);
															}
														}
													});
									...
									if (user.fazendas[findFazenda].lote4.bloqueado) {
										...
										message.reply('**Lote 4** desbloqueado com sucesso!').then((a) => a.delete({
											timeout: 7000
										}));
									} else {
										const plantar = msg1.createButtonCollector((button) => button.clicker.user.id === author.id, {
												...
												if (user.fazendas[findFazenda].lote4.fruta === '') {
													...
													colherFruta.on('collect', async (collected) => {
														...
														if (user.fazendas[findFazenda].lote4.fruta === itemEmoji2) {
															if (timeout - (Date.now() - user.fazendas[findFazenda].lote4.cooldown) > 0) {
																msg.delete();
																return message.reply(`você não pode colher ainda sua **${user.fazendas[findFazenda].lote4.fruta2}**! Espere: \`0${ms(timeout - (Date.now() - user.fazendas[findFazenda].lote4.cooldown)).hours}:${ms(timeout - (Date.now() - user.fazendas[findFazenda].lote4.cooldown)).minutes}:${ms(timeout - (Date.now() - user.fazendas[findFazenda].lote4.cooldown)).seconds}\``);
															} else {
																if (user.caixote.find((a) => a.item === user.fazendas[findFazenda].lote4.fruta2)) {
																	await this.client.database.users.findOneAndUpdate({
																		...
																		$set: {
																			'caixote.$.quantia': user.caixote.find((a) => a.item === user.fazendas[findFazenda].lote4.fruta2).quantia + 1
																		}
																	});
																} else {
																	await this.client.database.users.findOneAndUpdate({
																...
																msg.delete();
																return message.reply(`você colheu \`x1\` **${user.fazendas[findFazenda].lote4.fruta2}** do **Lote 4** com sucesso!`);
															}
														}
													});
									...
									if (user.fazendas[findFazenda].lote5.bloqueado) {
										...
										message.reply('**Lote 5** desbloqueado com sucesso!').then((a) => a.delete({
											timeout: 7000
										}));
									} else {
										const plantar = msg1.createButtonCollector((button) => button.clicker.user.id === author.id, {
												...
												if (user.fazendas[findFazenda].lote5.fruta === '') {
													...
													colherFruta.on('collect', async (collected) => {
														...
														if (user.fazendas[findFazenda].lote5.fruta === itemEmoji2) {
															if (timeout - (Date.now() - user.fazendas[findFazenda].lote5.cooldown) > 0) {
																msg.delete();
																return message.reply(`você não pode colher ainda sua **${user.fazendas[findFazenda].lote5.fruta2}**! Espere: \`0${ms(timeout - (Date.now() - user.fazendas[findFazenda].lote5.cooldown)).hours}:${ms(timeout - (Date.now() - user.fazendas[findFazenda].lote5.cooldown)).minutes}:${ms(timeout - (Date.now() - user.fazendas[findFazenda].lote5.cooldown)).seconds}\``);
															} else {
																if (user.caixote.find((a) => a.item === user.fazendas[findFazenda].lote5.fruta2)) {
																	await this.client.database.users.findOneAndUpdate({
																		...
																		$set: {
																			'caixote.$.quantia': user.caixote.find((a) => a.item === user.fazendas[findFazenda].lote5.fruta2).quantia + 1
																		}
																	});
																} else {
																	await this.client.database.users.findOneAndUpdate({
																...
																msg.delete();
																return message.reply(`você colheu \`x1\` **${user.fazendas[findFazenda].lote5.fruta2}** do **Lote 5** com sucesso!`);
															}
														}
													});
						...
						if (user.fazendas[findFazenda].lote1.fruta === 'Pêra') {
							timeout = 43200000;
						} else if (user.fazendas[findFazenda].lote1.fruta === 'Morango') {
							timeout = 64800000;
						} else if (user.fazendas[findFazenda].lote1.fruta === 'Tomate') {
							timeout = 86400000;
						}

						if (user.fazendas[findFazenda].lote2.fruta === 'Pêra') {
							timeout = 43200000;
						} else if (user.fazendas[findFazenda].lote2.fruta === 'Morango') {
							timeout = 64800000;
						} else if (user.fazendas[findFazenda].lote2.fruta === 'Tomate') {
							timeout = 86400000;
						}

						if (user.fazendas[findFazenda].lote3.fruta === 'Pêra') {
							timeout = 43200000;
						} else if (user.fazendas[findFazenda].lote3.fruta === 'Morango') {
							timeout = 64800000;
						} else if (user.fazendas[findFazenda].lote3.fruta === 'Tomate') {
							timeout = 86400000;
						}

						if (user.fazendas[findFazenda].lote4.fruta === 'Pêra') {
							timeout = 43200000;
						} else if (user.fazendas[findFazenda].lote4.fruta === 'Morango') {
							timeout = 64800000;
						} else if (user.fazendas[findFazenda].lote4.fruta === 'Tomate') {
							timeout = 86400000;
						}

						if (user.fazendas[findFazenda].lote5.fruta === 'Pêra') {
							timeout = 43200000;
						} else if (user.fazendas[findFazenda].lote5.fruta === 'Morango') {
							timeout = 64800000;
						} else if (user.fazendas[findFazenda].lote5.fruta === 'Tomate') {
							timeout = 86400000;
						}
						...
						if (user.fazendas[findFazenda].lote1.fruta === 'Abacaxi') {
							timeout = 57600000;
						} else if (user.fazendas[findFazenda].lote1.fruta === 'Melão') {
							timeout = 64800000;
						} else if (user.fazendas[findFazenda].lote1.fruta === 'Manga') {
							timeout = 86400000;
						}

						if (user.fazendas[findFazenda].lote2.fruta === 'Abacaxi') {
							timeout = 57600000;
						} else if (user.fazendas[findFazenda].lote2.fruta === 'Melão') {
							timeout = 64800000;
						} else if (user.fazendas[findFazenda].lote2.fruta === 'Manga') {
							timeout = 86400000;
						}

						if (user.fazendas[findFazenda].lote3.fruta === 'Abacaxi') {
							timeout = 57600000;
						} else if (user.fazendas[findFazenda].lote3.fruta === 'Melão') {
							timeout = 64800000;
						} else if (user.fazendas[findFazenda].lote3.fruta === 'Manga') {
							timeout = 86400000;
						}

						if (user.fazendas[findFazenda].lote4.fruta === 'Abacaxi') {
							timeout = 57600000;
						} else if (user.fazendas[findFazenda].lote4.fruta === 'Melão') {
							timeout = 64800000;
						} else if (user.fazendas[findFazenda].lote4.fruta === 'Manga') {
							timeout = 86400000;
						}

						if (user.fazendas[findFazenda].lote5.fruta === 'Abacaxi') {
							timeout = 57600000;
						} else if (user.fazendas[findFazenda].lote5.fruta === 'Melão') {
							timeout = 64800000;
						} else if (user.fazendas[findFazenda].lote5.fruta === 'Manga') {
							timeout = 86400000;
						}
						...
						if (user.fazendas[findFazenda].lote1.fruta === 'Pêssego') {
							timeout = 86400000;
						} else if (user.fazendas[findFazenda].lote1.fruta === 'Cereja') {
							timeout = 57600000;
						} else if (user.fazendas[findFazenda].lote1.fruta === 'Melancia') {
							timeout = 72000000;
						}

						if (user.fazendas[findFazenda].Lote2.fruta === 'Pêssego') {
							timeout = 86400000;
						} else if (user.fazendas[findFazenda].Lote2.fruta === 'Cereja') {
							timeout = 57600000;
						} else if (user.fazendas[findFazenda].lote2.fruta === 'Melancia') {
							timeout = 72000000;
						}

						if (user.fazendas[findFazenda].lote3.fruta === 'Pêssego') {
							timeout = 86400000;
						} else if (user.fazendas[findFazenda].lote3.fruta === 'Cereja') {
							timeout = 57600000;
						} else if (user.fazendas[findFazenda].lote3.fruta === 'Melancia') {
							timeout = 72000000;
						}

						if (user.fazendas[findFazenda].lote4.fruta === 'Pêssego') {
							timeout = 86400000;
						} else if (user.fazendas[findFazenda].lote4.fruta === 'Cereja') {
							timeout = 57600000;
						} else if (user.fazendas[findFazenda].lote4.fruta === 'Melancia') {
							timeout = 72000000;
						}

						if (user.fazendas[findFazenda].lote5.fruta === 'Pêssego') {
							timeout = 86400000;
						} else if (user.fazendas[findFazenda].lote5.fruta === 'Cereja') {
							timeout = 57600000;
						} else if (user.fazendas[findFazenda].lote5.fruta === 'Melancia') {
							timeout = 72000000;
						}
						...
						if (user.fazendas[findFazenda].lote1.fruta === 'Café') {
							timeout = 43200000;
						} else if (user.fazendas[findFazenda].lote1.fruta === 'Milho') {
							timeout = 57600000;
						} else if (user.fazendas[findFazenda].lote1.fruta === 'Arroz') {
							timeout = 86400000;
						}

						if (user.fazendas[findFazenda].lote2.fruta === 'Café') {
							timeout = 43200000;
						} else if (user.fazendas[findFazenda].lote2.fruta === 'Milho') {
							timeout = 57600000;
						} else if (user.fazendas[findFazenda].lote2.fruta === 'Arroz') {
							timeout = 86400000;
						}

						if (user.fazendas[findFazenda].lote3.fruta === 'Café') {
							timeout = 43200000;
						} else if (user.fazendas[findFazenda].lote3.fruta === 'Milho') {
							timeout = 57600000;
						} else if (user.fazendas[findFazenda].lote3.fruta === 'Arroz') {
							timeout = 86400000;
						}

						if (user.fazendas[findFazenda].lote4.fruta === 'Café') {
							timeout = 43200000;
						} else if (user.fazendas[findFazenda].lote4.fruta === 'Milho') {
							timeout = 57600000;
						} else if (user.fazendas[findFazenda].lote4.fruta === 'Arroz') {
							timeout = 86400000;
						}

						if (user.fazendas[findFazenda].lote5.fruta === 'Café') {
							timeout = 43200000;
						} else if (user.fazendas[findFazenda].lote5.fruta === 'Milho') {
							timeout = 57600000;
						} else if (user.fazendas[findFazenda].lote5.fruta === 'Arroz') {
							timeout = 86400000;
						}
