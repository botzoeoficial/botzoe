...
module.exports = class Revistar extends Command {
	...
	async run({
		...
		if (user.policia.isFolga) return message.reply('o Delegado do servidor deu uma folga para todos os **Policiais** do servidor, portanto, você não pode revistar ninguém ainda!');
